          ...
          <!-- Dropdown -->
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="industiraldesign.php">Industrial Design</a>
    ...
    <div class="container">
      ...
      <section>
        ...
        <h1 class="h1 orange-text text-center mb-3"> INVENTION </h1>    
          <p class="black-text lead col-8">"A new, useful process, machine, improvement, etc., that did not exist previously and that is recognized as the product of some unique intuition or genius, as distinguished from ordinary mechanical skill or craftsmanship."<a href="http://www.dictionary.com/browse/invention"><small>http://www.dictionary.com/browse/invention</small></a></p>
        </center>
        <!--Grid row-->
        <!-- Collapse buttons -->
        <div>
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body mx-3">
                          ...
                          <div class="md-form">
                              ...
                              <label for="invention_inventorsinventors">Inventor(s)</label>
                          </div>
