    ...
    <div class="container">
      ...
      <section>
        ...
        <center>
          ...
          if(isset($_GET['industrial_id']))
            {
              ...
              $industrial_title=$row['industrial_title'];
              $industrial_reg_no=$row['industrial_reg_no'];
              $agency_id=$row['agency_id'];
              $category_id=$row['category_id'];
              $industrial_filing_date=$row['industrial_filing_date'];
              $industrial_issue_date=$row['industrial_issue_date'];
              $industrial_publication_date=$row['industrial_publication_date'];
              $industrial_design_year=$row['industrial_design_year'];
              $inventor=$row['inventor'];
              $industrial_sketch=$row['industrial_sketch'];
          ...
          ?>
        <h1 class="h3 orange-text text-center">DISPLAY INDUSTRIAL DESIGN RECORD</h1>
        <h3>Title: </h3><br><h2></l><b><?php echo $industrial_title; ?></b></h2><br></lin>     
        <!-- Material form row -->
        <form>
            <div class="form-row">
                <div class="col">
                    <div class="md-form">
                        <textarea type="text" value="" id="textareaBasic" class="form-control md-textarea" rows="3" disabled><?php echo htmlspecialchars($industrial_reg_no); ?></textarea>
            ...
            <div class="form-row">
                ...
                <div class="col">
                  <div class="md-form">
                      <input type="text" class="form-control" value="<?php echo $industrial_design_year; ?>" id="formGroupExampleInputMD" disabled>
            ...
            <div class="form-row">
                <div class="col-4">
                    <div class="md-form">
                        <input type="text" class="form-control" value="<?php echo $industrial_filing_date; ?>" id="formGroupExampleInputMD"  disabled>
                        <label for="formGroupExampleInputMD">Filing Date</label>
                    </div>
                </div>
                <div class="col-4">
                    <div class="md-form">
                        <input type="text" class="form-control" value="<?php echo $industrial_issue_date; ?>" id="formGroupExampleInputMD" disabled>
                        <label for="formGroupExampleInputMD">Issue Date</label>
                    </div>
                </div>
                <div class="col-4">
                  <div class="md-form">
                      <input type="text" class="form-control" value="<?php echo $industrial_publication_date; ?>" id="formGroupExampleInputMD" disabled>
                      <label for="formGroupExampleInputMD">Publication Date</label>
                  </div>
                </div>
                <center>
                    <label>Sketch/es</label>
                    <div class="card w-100" style="width:100%;">
                        <div class="card-body text-center">
                          <?php
                            echo "
                            <img src = 'components/img/$industrial_sketch' width='300' height='auto' />
                            ";
                          ?>
                        ...
                        $rem_row = mysqli_fetch_assoc($fetch_res);
                          echo'
                            <div class="card border-warning mb-3 w-100" style="width:100%;">
                                <div class="card-header">Date & Time: '.$rem_row['industrial_remarks_time'].'</div>
                                <div class="card-body text-warning text-center">
                                    <h5 class="card-title">Description:</h5>
                                    <p class="card-text">'.$rem_row['industrial_remarks_desc'].'</p>
                                </div>
                            </div>
                            <br><br>';
                        }
                          ...
                          <form action="../../remarks.php" method="post" enctype="multipart/form-data" class="mod">
                            <div class="modal-content">
                                ...
                                <div class="modal-body mx-3">
                                  <div class="col">
                                    <div class="md-form">
                                        <textarea type="text" id="industrial_remarks_desc" name="industrial_remarks_desc" class="form-control md-textarea validate"></textarea>
                                        <label for="industrial_remarks_desc">Description</label>   
                                    </div>
                                  </div> 
                                  <div class="col">  
                                    <div class="md-form">
                                        <label for="industrial_remarks_time" disabled>Remark Date:</label><br>
                                        <input type="date" id="industrial_remarks_time" name="industrial_remarks_time" class="form-control validate">    
                                    </div>
                                  </div>
                                  </div>
