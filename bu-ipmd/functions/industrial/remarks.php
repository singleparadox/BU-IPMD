          ...
          if(isset($_GET['industrial_id']))
            {
              ...
              $_SESSION['industrial_id']=$industrial_id;
          ...
          <div class="col-6">
            <center>
                  <div clas="col-12">
                    ...
                    <br>
                      <?php
                        $rem_query = "SELECT * FROM industrial_remarks WHERE industrial_id=$industrial_id";
...
if (isset($_POST['insert_post'])) {
  ...
  $industrial_id = $_SESSION['industrial_id'];
  $industrial_remarks_time=$_POST['industrial_remarks_time'];
  $industrial_remarks_desc=$_POST['industrial_remarks_desc'];

  $insert_industrial_remarks = "INSERT INTO industrial_remarks(industrial_id,industrial_remarks_time,industrial_remarks_desc)
  
  VALUES('$industrial_id','$industrial_remarks_time','$industrial_remarks_desc')";
  ...
  $insert_industrialremarks = mysqli_query($connect, $insert_industrial_remarks);

  if ($insert_industrialremarks) {
    $industrial_id= $_SESSION['industrial_id'];
    echo "<script>alert('Remarks added!')</script>";
    echo "<script>window.open('remarks.php?industrial_id=".$industrial_id.",'_self')</script>";
  }
}
?>