          ...
          <div class="col-6">
            <center>
                  <div clas="col-12">
                    ...
                    <br>
                      <?php
                        $rem_query = "SELECT * FROM utility_remarks WHERE um_id=$um_id";
...
if (isset($_POST['insert_post'])) {
  ...
  $um_remarks_time=$_POST['um_remarks_time'];
  $um_remarks_desc=$_POST['um_remarks_desc'];

  $insert_utility_remarks = "INSERT INTO utility_remarks(um_id,um_remarks_time,um_remarks_desc)
  
  VALUES('$um_id','$um_remarks_time','$um_remarks_desc')";
  ...
  $insert_umremarks = mysqli_query($connect, $insert_utility_remarks);

  if ($insert_umremarks) {
    $um_id= $_SESSION['um_id'];
    echo "<script>alert('Remarks added!')</script>";
    echo "<script>window.open('remarks.php?um_id=".$um_id.",'_self')</script>";
  }
}
?>